...
-- insert
insert into spring.customer (name,surname,email,password) values ("Hamit44","Mızrak44","hamitmizrak@gmail.com","Hm123456@");

-- delete
delete FROM spring.customer where id="10";

-- update
update  spring.customer  set name="Hamit55",surname="Mızrak55" where id =1;

-- find
select * from spring.customer where id =9;
...
-- name ve surname
select * from spring.customer where name like 'h%' and surname like ''
